...
# ww = gl.GLViewWidget()
# ww.show()
# ww.setWindowTitle('pyqtgraph example')
# ww.setCameraPosition(distance=15, azimuth=-90)
# g = gl.GLGridItem()
# g.scale(2, 2, 1)
# ww.addItem(g)
...
colors = np.array([[1,1,0,1] for i in range(12)])
mi6= gl.GLMeshItem(vertexes=cube_md.vertexes(), faces=cube_md.faces(), faceColors=colors, drawEdges=True, edgeColor=(1, 0, 0, 1))
w.addItem(mi6)
